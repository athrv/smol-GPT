...
# here are all of the distinct characters in the text
...
optminizer=torch.optim.AdamW(model.parameters(), lr=learning_rate)
...
for iter in range(max_iters):
    ...
    optminizer.zero_grad(set_to_none=True)
    loss.backward()
    optminizer.step()
